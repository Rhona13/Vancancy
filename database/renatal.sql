...
--
-- Host: 127.0.0.1
-- Generation Time: May 15, 2024 at 06:42 AM
...
ALTER TABLE `transaction`
  ...
  ADD KEY `fk_houses` (`h_id`),
  ADD KEY `fk_occupant` (`o_id`);
...
--
ALTER TABLE `houses`
  MODIFY `h_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `rent`
--
ALTER TABLE `rent`
  MODIFY `t_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=58;

--
-- AUTO_INCREMENT for table `transaction`
--
ALTER TABLE `transaction`
  MODIFY `p_id` int(250) NOT NULL AUTO_INCREMENT;
COMMIT;
